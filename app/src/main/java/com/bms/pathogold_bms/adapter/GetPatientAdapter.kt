...
class GetPatientAdapter (val context:Context,val getPatientBOArrayList: ArrayList<GetPatientBO>,val bookAppointmentFragment: BookAppointmentFragment): RecyclerView.Adapter<GetPatientAdapter.GetPatientViewHolder>() {
    ...
    override fun onBindViewHolder(holder: GetPatientViewHolder, position: Int) {
        ...
        holder.btnSelect.setOnClickListener {
            bookAppointmentFragment.setSelectedData(getPatientBOArrayList[position])
        }
    }
