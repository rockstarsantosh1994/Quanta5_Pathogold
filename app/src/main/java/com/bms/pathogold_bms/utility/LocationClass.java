...
public class LocationClass implements LocationListener {
    ...
    public LocationClass(Context context, Activity activity) {
                        ...
                        if (location == null) {
                            ...
                            if (locationManager != null) {
                                ...
                                if (location != null) {
                                 ...
                                 //   getLocation();
                               /*     new Utility().getToast(mActivity,"Unable to pick the location, Please change your location.");
                                    return null;*/
                                }
                            }
                        }catch (Exception e){
                        ...
                        try {
                            ...
                            if (locationManager != null) {
                                ...
                                if (location != null) {
                                    ...
                                    //     getLocation();
                                    Toast.makeText(mActivity, "Unable to fetch the location, Please change your location.", Toast.LENGTH_SHORT).show();
                                    return null;
                                }
                            }
                        }catch (Exception e){
